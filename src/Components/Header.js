...
<>
    ...
    <div style={{backgroundColor:"#FAFAFA",position:"absolute",marginTop:180,width:"65%",height:"50%",boxShadow:"rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px"}}>
        <div className="row">
        <div className="col">
